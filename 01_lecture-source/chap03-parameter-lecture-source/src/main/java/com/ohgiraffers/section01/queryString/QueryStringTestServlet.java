...
public class QueryStringTestServlet extends HttpServlet {
    ...
    * */
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String name = request.getParameter("name");  // 사용자가 쓴 이름응ㄹ 꺼내오기 / "name" 에서 가져와야함!(=스캐너의 역할)// key와 value의 값으로!!
        System.out.println("name = " + name);

        int age = Integer.parseInt(request.getParameter("age")); // parcing 하기!(String값 요구했는데 age인 int값을 받으므로)
        ...
        // getParameter() -> x, geParameterValues()
